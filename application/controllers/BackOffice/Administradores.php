...
class Administradores extends CI_Controller
{
    ...
    function index()
    {
        ...
        $footer_data = array(
            ...
            <script src="' . base_url() . 'assets/js/Admin/components/pages/administradoresTableSection.js"></script>'
        );
        ...
        $this->load->view('Admin/pages/administradores', $section_data);
    ...
    function create_pdf()
    {
        ...
        $table_data = $this->Model_Admin->all();
