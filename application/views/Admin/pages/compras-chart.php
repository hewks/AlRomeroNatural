    ...
    <div class="bs-page-section-table">
        <div class="bs-page-section-header">
            ...
            <div class="bs-header-section-right">
                <a href="<?= base_url() ?>BackOffice/<?= $section ?>/create_pdf?type=compras" class="bs-section-download"><i class="fas fa-file-export"></i></a>
            </div>
        </div>
        <div class="bs-page-section-body">
            <div class="bs-page-chart-container">
                <canvas class="bs-page-chart" id="bs-buy-chart"></canvas>
            </div>
        </div>
    </div>
