...
<div class="hw-fluid-container">
    <div class="hw-row-container">
        <div class="hw-row-col-50 hw-mb-25">
        ...
        <div class="hw-row-col-50 hw-total-center-container">
            <div class="hw-text-container">
                <p class="hw-font-theme-2 hw-text-justify hw-mw-90 hw-pb-12">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro deleniti voluptatum eligendi officia est in culpa eius itaque aut molestiae dicta similique autem, repudiandae ex nisi, fuga eos facilis provident.</p>
                <p class="hw-font-theme-2 hw-text-justify hw-mw-90 hw-pb-12">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro deleniti voluptatum eligendi officia est in culpa eius itaque aut molestiae dicta similique autem, repudiandae ex nisi, fuga eos facilis provident.</p>
            </div>
        </div>
    </div>
